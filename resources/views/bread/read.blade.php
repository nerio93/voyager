            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered" style="padding-bottom:5px;">
                    ...
                    @foreach($dataType->readRows as $index => $row)
                        @if (in_array($dataType->slug, explode(",", env('HIDE_FIELDS_IF_EMPTY_ON',"document,"))) )
                        ...
                        @endif
                            @if (in_array($dataType->slug, explode(",", env('HIDE_FIELDS_IF_EMPTY_ON',"document,"))) && empty($dataTypeContent->{$row->field}) || !in_array($dataType->slug, explode(",", env('HIDE_FIELDS_IF_EMPTY_ON',"document,"))))
                                @if (isset($dataTypeContent->{'row_color'}))
                                    @if ($dataTypeContent->{'row_color'} !== null && !empty($dataTypeContent->{'row_color'}) && $index == 0)
